...
이 랩에서는 세 페이지로 구성된 보고서를 만듭니다. 그런 다음 보고서를 Power BI에 게시합니다. 이렇게 하면 보고서를 열고 상호 작용할 수 있습니다.
...
이 연습에서는 **Sales Report**라는 세 페이지짜리 보고서를 만듭니다.
...
1. **필드** 창에서 **날짜 \| 연도** 필드(계층 구조의 **연도** 수준이 아님)를 시각화 창의 슬라이서 **필드**로 끕니다.
...
1. 시각적 개체 필드 창(**필드** 창이 아니며 **시각화** 창 아래에 있음)에서 필드가 **x-축** 및 **열 y-축** 웰/영역에 할당되었는지 확인합니다.
...
1. **필드** 창에서 **Sales \| Profit Margin** 필드를 **꺾은선형 y-축** 웰/영역으로 끌어 옵니다.
...
1. **필드** 창에서 **Product \| Category** 필드를 **이 페이지의 필터** 웰/영역으로 끌어옵니다.
...
이 연습에서는 보고서를 Power BI 서비스 게시하고 읽기 전용 소비자 보고서를 살펴봅니다.
 ...
 *Power BI Desktop 보고서 향상 랩에서 고급 기능을 사용하여 보고서 디자인을 향상**시킵니다**.*
