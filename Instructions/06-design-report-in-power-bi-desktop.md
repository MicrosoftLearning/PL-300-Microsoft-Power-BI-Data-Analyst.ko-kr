...
이 연습에서는 **Sales 보고서**라는 세 페이지로 구성된 보고서를 만듭니다.
...
9. Year 값 테이블이 보고서 페이지에 추가된 것을 볼 수 있습니다.
...
28. 시각적 개체 필드 창의 **x-축** 웰/영역에서 **Month** 필드에 대해 아래쪽 화살표를 클릭한 후 **데이터 없이 항목 표시**를 선택합니다.
...
39. **막대**와 **Color** 그룹을 차례로 확장한 후 **기본 Color** 속성을 적절한 Color(세로 막대형 차트/꺾은선형 차트를 보완하는 Color)으로 설정합니다.
...
1. 다음 필드를 시각적 개체 웰/영역에 추가합니다.
    ...
    - X축: **Sales \| Sales** 및 **Targets \| Targets**
...
2. 작업 영역의 내용을 검토하여 **Sales 분석** 보고서와 데이터 세트를 확인합니다.
...
3. 보고서를 열려면 **Sales 분석** 보고서를 클릭합니다.
...
6. 세로 막대형/꺾은선형 차트에서 Month 열을 선택하여 페이지를 교차 필터링합니다.
...
18. **Region** 슬라이서는 **개요** 페이지의 **Region** 슬라이서와는 다음 선택 옵션을 포함합니다.
