...
1. Power BI Desktop에서 **파일** > **보고서 열기** > **보고서 찾아보기**로 이동합니다.

1. **D:\Allfiles\Labs\06-design-report-in-power-bi-desktop\Starter** 폴더에서 **판매 분석** 파일을 엽니다.

1. **파일** > **다른 이름으로 저장**으로 이동하여 파일 복사본을 만들고 **D:\Allfiles\MySolution** 폴더에 복사본을 저장합니다.
...
이 작업에서는 세 번째이자 최종 보고서 페이지를 설계합니다. 디자인을 완료하면 페이지는 다음과 같은 모습이 됩니다.
 ...
 *이제 동일한 데이터가 두 가지 다른 시각화 유형으로 표현되는 것을 볼 수 있습니다. 이는 페이지 레이아웃을 잘 활용하는 것은 아니지만 **Power BI Desktop에서 보고서 개선** 랩에서 시각적 개체를 겹쳐 개선할 수 있습니다. 단추를 페이지에 추가하면 보고서 사용자가 두 시각적 개체 중 표시할 시각적 개체를 결정할 수 있습니다.*

 *이제 세 번째이자 마지막 페이지의 디자인이 완료되었습니다.*

## **보고서 게시**

이 작업에서는 보고서를 Power BI 서비스에 게시합니다.
...
1. 작업 영역의 콘텐츠를 검토합니다. 전체, 콘텐츠, 의미 체계 모델 + 데이터 흐름의 탐색 옵션을 확인합니다.
    1. *작업 영역에는 네 가지 형식의 항목이 있을 수 있으며, **보고서**와 **의미 체계 모델**에 대해 알아보겠습니다.*
    1. *의미 체계 모델이 표시되지 않으면 Microsoft Edge 브라우저를 새로 고쳐야 할 수도 있습니다.*
...
"내 작업 영역"으로 돌아가려면 창 웹 페이지 배너에서 **내 작업 영역**을 선택합니다.

 ***Power BI Desktop에서 보고서 향상** 랩의 유용한 기능을 사용하여 보고서 디자인을 향상시키게 됩니다.*
