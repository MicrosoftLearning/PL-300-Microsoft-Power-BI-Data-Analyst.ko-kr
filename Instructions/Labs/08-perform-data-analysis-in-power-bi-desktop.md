...
*이 메서드는 보고서 및 의미 체계 모델을 만듭니다. 이 연습에서는 의미 체계 모델만 사용하여 새 보고서를 만듭니다. 이 동일한 프로세스는 새 보고서를 업로드하는 대신 다른 보고서의 기존 의미 체계 모델을 사용하여 수행할 수 있습니다. 또한 보고서를 사용하지 않는 경우 작업 영역 모범 사례에서 불필요한 파일을 삭제하는 것이 좋습니다.*

## **보고서 만들기**

이 작업에서는 마지막 작업에서 만든 Power BI 의미 체계 모델에 대한 라이브 연결을 만든 다음 새 **Sales Exploration** 보고서를 만듭니다.
...
1. 홈 리본에서 데이터 가져오기 > Power BI 의미 체계 모델을** 선택합니다**.
