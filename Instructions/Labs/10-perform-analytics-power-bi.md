...
폴더를 **C:\Users\Student\Downloads\10-perform-analytics** 폴더로 추출합니다.

1. **10-스타터-영업 분석.pbix** 파일을 엽니다.
...
1. 보고서 페이지에 **분산형 차트** 시각적 개체를 추가한 다음 전체 페이지를 채우도록 크기를 조정하여 배치합니다.
    ...
    > 필드가 **재생 축** 웰/영역에 추가되면 차트를 애니메이션화할 수 있습니다.
     ...
     ![그림 18](Linked_image_Files/10-perform-analytics-power-bi_image15.png)

     ![그림 75](Linked_image_Files/10-perform-analytics-power-bi_image16.png)
...
1. 차트에 애니메이션을 적용하려면 왼쪽 하단에서 **재생**을 선택합니다.
    ...
    ![그림 41](Linked_image_Files/10-perform-analytics-power-bi_image19.png)
...
1. 보고서 페이지에 **꺾은선형 차트** 시각적 개체를 추가한 다음 전체 페이지를 채우도록 크기를 조정하여 배치합니다.
     ...
     ![그림 19](Linked_image_Files/10-perform-analytics-power-bi_image21.png)

     ![그림 74](Linked_image_Files/10-perform-analytics-power-bi_image22.png)
...
1. 예측을 추가하려면 **시각화** 창 아래에서 **Analytics** 창을 선택합니다.
     ...
     ![그림 20](Linked_image_Files/10-perform-analytics-power-bi_image26.png)
...
1. 다음 예측 속성을 구성한 후 **적용**합니다.
    ...
    ![그림 52](Linked_image_Files/10-perform-analytics-power-bi_image29.png)
