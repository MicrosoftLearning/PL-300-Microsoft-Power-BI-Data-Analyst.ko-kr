...
1. **가져오기 > 보고서, 페이지를 매긴 보고서 또는 통합 문서 > 이 컴퓨터에서**를 선택합니다.
...
1. **개요** 페이지에서 **연도** 슬라이서를 **FY2020**으로 설정합니다.
    ...
    ![그림 4](Linked_image_Files/12-create-power-bi-dashboard_image17.png)
...
1. 메시지가 표시되면 드롭다운 메뉴에서 **판매 모니터링**을 선택하고 **고정**을 선택합니다.
...
2. **이미지 타일 추가** 창의 **URL** 상자에 텍스트 파일의 URL을 붙여넣은 다음, **적용**을 클릭합니다.
...
1. Power BI Desktop 파일의 **데이터** 창에서 **판매** 테이블을 마우스 오른쪽 단추로 클릭한 다음, **데이터 > 새로 고침**을 선택합니다.
...
3. 또한 이제 **2020년 6월**에 해당하는 열이 생겼습니다.
    ...
    ![그림 33](Linked_image_Files/12-create-power-bi-dashboard_image50.png)
