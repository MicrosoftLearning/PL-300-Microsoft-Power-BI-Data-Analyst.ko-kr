...
1. 두 번째 규칙(녹색 원)을 다음과 같이 구성한 다음 **확인을** 선택합니다.
...
1. **이 기준은 무엇인가요?** 드롭다운 목록에서 **제품 \| 서식 배경색 형식을 \|** 선택한 다음 **확인을** 선택합니다.
...
이 연습에서는 보고서 사용자가 표시할 시각적 유형을 선택할 수 있도록 단추가 있는 **내 성능** 페이지를 향상시킵니다. 디자인을 완료하면 페이지는 다음과 같은 모습이 됩니다.
...
이 작업에서는 두 개의 책갈피를 추가합니다. 하나는 월별 판매/대상 시각적 개체 각각을 표시하는 책갈피입니다.
...
1. 책갈피를 편집하려면 **책갈피** 창에서 책갈피 위로 커서를 가리키고 줄임표를 선택한 다음 **데이터를** 선택합니다.
